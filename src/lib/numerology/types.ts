...
export const GridPatternDefinitionSchema = z.object({
  name: z.string(),
  category: z.string(),
...
export type GridPatternDefinition = z.infer<typeof GridPatternDefinitionSchema>
...
export type GridAnalysisResult = z.infer<typeof GridAnalysisResultSchema>
