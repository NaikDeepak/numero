...
export function generateCompatibilityPrompt(
  ...
  `
    ...
    <verify>grep "generateCompatibilityPrompt" src/lib/ai/prompts.ts</verify>
  </task>
...
export async function getCompatibility(user: ProfileInput, partner: ProfileInput) {
  ...
  try {
    ...
    <verify>ls src/app/actions/compatibility.ts</verify>
  </task>
...
export function CompatibilityResult({ analysis, user, partner }: CompatibilityResultProps) {
  return (
    ...
    <verify>ls src/components/numerology/compatibility-result.tsx</verify>
  </task>
...
export default function CompatibilityPage() {
  ...
  return (
    ...
    <verify>ls src/app/compatibility/page.tsx</verify>
  </task>
  ...
  <task>
    ...
    <verify>grep "compatibility" src/app/page.tsx</verify>
  </task>
...
import Link from "next/link"</new_string>
    ...
    <verify>grep "Link" src/app/page.tsx</verify>
  </task>
</tasks>
